...
> Nota: este despliegue tiene fines de aprendizaje y prueba de arquitectura. 
> Puede ser desmontado una vez cumplido su propósito exploratorio.
...
![Panel de Coolify](docs/screenshots/coolify-panel.png)
*Vista general de los recursos desplegados en el Servidor C.*

![n8n en producción](docs/screenshots/n8n-dashboard.png)
*n8n accesible en `n8n.entornoandres.me`, con SSL propio.*

![JupyterLab en producción](docs/screenshots/jupyterlab-dashboard.png)
*JupyterLab accesible en `jupyter.entornoandres.me`, entorno de desarrollo Python.*

![Workflow n8n + PostgreSQL](docs/screenshots/n8n-postgres-test.png)
*Prueba de conexión: n8n consultando fecha y versión de PostgreSQL.*

![Workflow n8n + Ollama](docs/screenshots/n8n-ollama-test.png)
*Prueba de comunicación entre Servidor C y Servidor B vía red privada.*

![pgAdmin conectado](docs/screenshots/pgadmin-tabla-prueba.png)
*Tabla de prueba creada desde n8n, visible en pgAdmin.*
